...
public class PopLog extends Contract {
    ...
    public Flowable<TransRetLogEventResponse> transRetLogEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, TransRetLogEventResponse>() {
            @Override
    ...
    public Flowable<OrderLogEventResponse> orderLogEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, OrderLogEventResponse>() {
            @Override
    ...
    public Flowable<DebugRetLogEventResponse> debugRetLogEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, DebugRetLogEventResponse>() {
            @Override
    ...
    public Flowable<NewAccountEventResponse> newAccountEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, NewAccountEventResponse>() {
            @Override
